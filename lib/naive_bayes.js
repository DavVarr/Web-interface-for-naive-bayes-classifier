 ...
 *
 * @param  {String} text
 * @param  {Boolean} decides if it is returned the category 
 * @return {Promise<string>|Promise<Object>} category or object with a log probability of belonging for each category.
 */
Naivebayes.prototype.categorize = async function (text,getProbabilities = false) {
  var self = this
...
*/
Naivebayes.prototype.get = function(attribute){
  if(!STATE_KEYS.includes(attribute)) throw new Error("no attribute named "+ attribute)
  self = this
